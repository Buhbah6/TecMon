...
func _ready() -> void:
	...
	MessageBus.register(null, self)
	MessageBus.dialogue_requested.connect(_on_message_requested)
...
func _on_message_requested(messages: Array[String], speed: int, portrait: Sprite2D) -> void:
	sprite.texture = portrait.texture
	sprite.region_enabled = true
	sprite.region_rect = portrait.region_rect
